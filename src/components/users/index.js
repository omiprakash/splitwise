...
import { getLocalStorage, setLocalStorage, emailValidator, formatCurrency } from './../../utils/commonUtils'
                ...
                <div className="user-wrapper container">
                    <div className="form-wrapper">
                        ...
                        <div className="formgroup">
                            ...
                            <label className="errorEmail" id="emailError">{this.state.emailError}</label>
                        </div>
                        <div className="formgroup">
